...
var UserRoutingModule = (function () {
    ...
    UserRoutingModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, forms_1.FormsModule, employee_module_1.EmployeeModule, student_module_1.StudentModule, router_1.RouterModule.forChild(routes)],
            declarations: [],
            providers: [],
