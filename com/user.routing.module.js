...
var routes = [
    { path: 'employee', loadChildren: 'com/employee.module#EmployeeModule' },
    { path: 'student', component: student_component_1.StudentComponent },
];
exports.routedComponents = [student_component_1.StudentComponent];
var UserRoutingModule = (function () {
    function UserRoutingModule() {
    }
    UserRoutingModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, forms_1.FormsModule, router_1.RouterModule.forChild(routes)],
